...
def process_command(c):
    ...
    if "open google" in c:
        ...
        threading.Thread(target=open_browser, args=(f"https://open.spotify.com/search/{urllib.parse.quote(song)}",)).start()
        ...
        add_chat("I am Kalexa, your personal assistant.")
        ...
        add_chat("I am Kalexa, your virtual assistant created to help you with various tasks.")
...
def start_listening():
    def listen_continuously():
        update_ui_listening()
        speak("Hello! I am Kalexa, your personal assistant. How can I help you?")
        while True:
            try:
                play_beep()
...
conversation_text.tag_config("kalexa", foreground="#00796b", font=('Helvetica', 12, 'bold'))
conversation_text.tag_config("user", foreground="#004d40", font=('Helvetica', 12))
conversation_text.config(state=tk.DISABLED)

# Initial commands to display on startup
initial_commands = [
    "Welcome! I am Kalexa, your personal assistant.",
    "You can ask me to open Google, YouTube, or Spotify.",
    ...
    "Start by saying 'Hey Kalexa' to begin a command."
]

# Function to display initial commands
def display_initial_commands():
    for cmd in initial_commands:
        add_chat(cmd, sender="Kalexa", speak_response=False)
